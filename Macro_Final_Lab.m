...
for t = 1:T
        ...
        shock(t)= zeta(zt(t)); %Nos dice cuál es el valor del schock
end
...
for i=1:p % número de puntos en la malla de activos
    for j=1:q % número de puntos en la malla del choque
        for t=1001:10000 % no considera las primeras 1000 observaciones
            if ai(t)==i && zt(t)==j %toma el índice óptimo y lo evalua con la iteración en la que se encuentra, es un estado
